...
public class Heartbeat implements Serializable, Comparable<Heartbeat>, Identifiable {
		...
		public String toString() {
			return new StringBuilder().append(" Sequence: ").append(sequenceId).append(" - Created: ")
						.append(getCreation()).append(" - ShardID: ").append(getShardId()).append(" - Duties: ")
						.append(getDuties().size()).toString();
		}
