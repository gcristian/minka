 ...
 *
 */
public class ShardCommand implements Serializable {
	...
	public ShardCommand(final Command command, final NetworkShardID shardId) {
        ...
        Validate.isTrue(
                command ==Command.FOLLOWER_DEACTIVATE ||
                command ==Command.FOLLOWER_ACTIVATE || 
                command == Command.FOLLOWER_DECOMISSION ||
                command == Command.FOLLOWER_HOARD, "this type is inalid for a host");
